...
class Camera
{
    private:
        ...
        //! Private method
        /*!
        *\fn void computeDirectionVectors()
        * Compute the direction of front, left and up vector
        * according to Phi and Theta angle (only for FREELY MODE)
        */
    ...
    public:
        // CONSTANTS
        /*!
        * Enumeration of all the camera states
        */
        enum CAMERA_STATE
        {
            LOCKED = 0,
        ...
        /*!
        * Enumeration of all the camera mode
        */
        enum CAMERA_MODE
        {
            TRACKBALL = 0,
